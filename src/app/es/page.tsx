      ...
      <main className="relative max-w-4xl m-auto my-16 flex flex-col gap-16 px-6 bg-slate-300 dark:bg-background-dark text-black dark:text-white antialiased">
        ...
        <header className="space-y-8">
          ...
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
              ...
              preparatoria y me gradué como ingeniero de software junior.
              Después de eso, comencé a estudiar una licenciatura en desarrollo
              de software y me gradué en junio de 2024.
            </p>
            <p>
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            ...
            Next.js, Tailwind CSS y más. También estudio arquitectura de
            software, patrones de diseño y mejores prácticas en el desarrollo de
            software.
          </p>
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            Aquí está mi CV si quieres saber más sobre mi experiencia y
            formación.
          </p>
